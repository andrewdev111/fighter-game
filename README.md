...
После деплоя на Vercel убедитесь, что:

- Папка `assets/` с файлами `tramp.png` и `mask.png` включена в репозиторий
- Файлы доступны по адресу: `https://your-vercel-app.vercel.app/assets/tramp.png`
- Если спрайты не загружаются, игра автоматически использует цветные прямоугольники
